...
func TestLoad_DefaultValues(t *testing.T) {
	...
	assert.NotEmpty(t, cfg.GetJWTSecret()) // Should be auto-generated
}
...
func TestLoad_JWTSecret_AutoGenerated(t *testing.T) {
	...
	assert.NotEmpty(t, cfg.GetJWTSecret())
	// Should be a valid base64 string or the fallback
	assert.True(t, len(cfg.GetJWTSecret()) > 10)
}
...
func TestLoad_JWTSecret_FromEnv(t *testing.T) {
	...
	assert.Equal(t, expectedSecret, cfg.GetJWTSecret())
}
...
func TestLoad_IntegrationScenario(t *testing.T) {
	...
	assert.Equal(t, "super-secret-jwt-key-for-production", cfg.GetJWTSecret())
}
